...
public class ServletEnviar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sobren = request.getParameter("surname");
        String apelido = request.getParameter("nick");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Sobrenome: " + sobren + "<br/>");
            out.println("Apelido: " + apelido + "<br/>");
            out.println("E-mail: " + mail + "<br/>");
            out.println("Senha: " + pass + "<br/>");
            out.println("Nascimento: " + data + "<br/>");
            out.println("</body>");
            out.println("</html>");
        }
    }
